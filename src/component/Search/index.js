...
export default function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true)
                let response = await fetch(`https://masak-apa-tomorisakura.vercel.app/api/search/?q=${search}`);
        ...
        <div>
            ...
            <div className='mt-44 flex justify-center gap-5'>
                <input
                    ...
                    type="text"
                    placeholder='Ketik keyword resep ...'
                    className='pl-3  font-primary w-52 md:w-72 h-10 rounded-full border-2 border-primary' />

            </div>



            <div className='mt-5 flex flex-wrap gap-6 justify-center pb-10'>
